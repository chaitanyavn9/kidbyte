...
const LESSON_BG: Record<string, { from: string; to: string }> = {
  ...
  gpu:                 { from: "#86EFAC", to: "#16A34A" },
  rom:                 { from: "#FDE68A", to: "#D97706" },
  ssd:                 { from: "#67E8F9", to: "#0891B2" },
  "cooling-fan":       { from: "#BAE6FD", to: "#0284C7" },
  motherboard:         { from: "#D8B4FE", to: "#9333EA" },
  battery:             { from: "#BBF7D0", to: "#15803D" },
  files:               { from: "#FEF08A", to: "#CA8A04" },
  os:                  { from: "#FDA4AF", to: "#E11D48" },
  software:            { from: "#A5F3FC", to: "#06B6D4" },
  "drag-drop":         { from: "#FED7AA", to: "#EA580C" },
  "bits-bytes":        { from: "#D9F99D", to: "#65A30D" },
  hexadecimal:         { from: "#F5D0FE", to: "#A21CAF" },
  "machine-language":  { from: "#6EE7B7", to: "#047857" },
  rgb:                 { from: "#FCA5A5", to: "#DC2626" },
  "hex-colors":        { from: "#FBCFE8", to: "#BE185D" },
  resolution:          { from: "#93C5FD", to: "#1E40AF" },
  "hard-disk":         { from: "#CBD5E1", to: "#475569" },
  "ssd-deep":          { from: "#6EE7B7", to: "#0F766E" },
  "memory-allocation": { from: "#FDE68A", to: "#B45309" },
  "what-is-code":      { from: "#A5B4FC", to: "#4F46E5" },
  "python-intro":      { from: "#FDE68A", to: "#2563EB" },
  "scratch-intro":     { from: "#FCA5A5", to: "#FF6B35" },
};
